...
class Stock(models.Model):
	...
	receiveQuantity=models.IntegerField(blank=True,null=True)
	receiveBy=models.CharField(max_length=50,blank=True,null=True)
	issueQuantity=models.IntegerField(blank=True,null=True)
	...
	ExportCSV=models.BooleanField(default=False)
	lastUpdate=models.DateTimeField(auto_now_add=False,auto_now=True)
	created=models.DateTimeField(auto_now_add=True)
